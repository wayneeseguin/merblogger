...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "History.txt", "LICENSE", "Manifest.txt", "README.txt", "Rakefile", "TODO", "lib/data_objects.rb", "lib/data_objects/command.rb", "lib/data_objects/connection.rb", "lib/data_objects/field.rb", "lib/data_objects/logger.rb", "lib/data_objects/quoting.rb", "lib/data_objects/reader.rb", "lib/data_objects/result.rb", "lib/data_objects/transaction.rb", "lib/data_objects/uri.rb", "lib/data_objects/version.rb", "spec/command_spec.rb", "spec/connection_spec.rb", "spec/dataobjects_spec.rb", "spec/do_mock.rb", "spec/reader_spec.rb", "spec/result_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "spec/transaction_spec.rb", "spec/uri_spec.rb"]
  s.has_rdoc = true
